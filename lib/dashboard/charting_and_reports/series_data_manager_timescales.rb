...
class OptimumStartPeriods < FrostDayPeriods
  ...
  protected def morning_temperature_range(temp_range)
  ...
  protected def school_weeks_with_heating_on
    weeks = []
  ...
  private def calculate_heating_model
