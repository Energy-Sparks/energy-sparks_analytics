class ManagementSummaryTable2 < ContentBase
  ...
  def self.template_variables
    { 'Adult dashboard management summary table' => TEMPLATE_VARIABLES}
  end
  ...
  def values_for_fuel_type(fuel_type)
    last_4_week_comparison  = compare_two_periods(fuel_type, { workweek: 0 }, { workweek: -1 }, MAX_DAYS_OUT_OF_DATE_FOR_4_WEEK_COMPARISON)
