...
class BenchmarkComparisonAdvice < DashboardChartAdviceBase
  ...
  def generate_advice
    ...
    header_template = %{
      ...
      <% end %>
      <p>
        <%= @school.name %> is a <%= @school.school_type.to_s.humanize.downcase %> school near <%= address %>
  ...
  def tariff_change_saving_to_exemplar_html_deprecated(fuel)
    ...
    " (#{£current} at your current tariff)"
  end
  ...
  def tariff_changed_spend_html_deprecated(fuel)
    ...
    ", #{kwh_html} at your current tariff"
  end

  def gas_tariff_change_text_deprecated
...
class GasLongTermTrend < DashboardChartAdviceBase
  ...
  def generate_advice
    header_template = %{
      <%= @body_start %>
        <h2>How your gas usage has changed over the last few years</h2>
        <p>
...
class ElectricityLongTermTrend < DashboardChartAdviceBase
  ...
  def generate_advice
    header_template = %{
      <%= @body_start %>
        <h2>How your electricity usage has changed over the last few years</h2>
        <p>
