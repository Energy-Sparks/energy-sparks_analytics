class AlertElectricityPeakKWVersusBenchmark < AlertElectricityOnlyBase
  ...
  private def calculate(asof_date)
    ...
    @exemplar_kw = benchmark_kw_m2 * floor_area
    ...
    @one_year_saving_versus_exemplar_kwh = 4.0 * 190.0 * [@average_school_day_last_year_kw_per_floor_area - benchmark_kw_m2, 0.0].max * floor_area
