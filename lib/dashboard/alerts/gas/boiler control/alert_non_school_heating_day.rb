...
class AlertHeatingOnNonSchoolDays < AlertHeatingDaysBase
  ...
  private def calculate(asof_date)
    ...
    @below_frost_£ = @kwh_below_frost_on_unoccupied_days * BenchmarkMetrics.pricing.gas_price
    @unoccupied_above_frost_£ = @one_year_saving_kwh * BenchmarkMetrics.pricing.gas_price
    @unoccupied_above_frost_co2 = @one_year_saving_kwh * EnergyEquivalences::UK_GAS_CO2_KG_KWH
    @total_on_unoccupied_days_£   = @total_kwh_on_unoccupied_days * BenchmarkMetrics.pricing.gas_price
