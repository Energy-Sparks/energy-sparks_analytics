...
describe HotWater::GasHotWaterService do
  ...
  describe '#create_model' do
    ...
    it 'creates a model for results of a heating thermostatic analysis' do
      expect(model.investment_choices.existing_gas.annual_co2).to be_within(0.01).of(22_587.47)
      ...
      expect(model.investment_choices.gas_better_control.saving_co2).to be_within(0.01).of(10_937.26)
      ...
      expect(model.investment_choices.gas_better_control.annual_co2).to be_within(0.01).of(11_650.20)
      ...
      expect(model.investment_choices.point_of_use_electric.saving_co2).to be_within(0.01).of(17_549.24)
