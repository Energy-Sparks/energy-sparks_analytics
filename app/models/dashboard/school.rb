...
module Dashboard
  class School
    ...
    attr_reader :name, :id, :address, :floor_area, :number_of_pupils, :school_type, :area_name, :postcode, :activation_date, :created_at, :school_times, :community_use_times, :location, :data_enabled
    attr_accessor :urn
