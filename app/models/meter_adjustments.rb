...
class MeterAdjustments
  ...
  def self.meter_adjustment(meter)
    ...
    # Old - integration branch, but now commented out in latest master - Oct2018
    # when 13685103, 13684909 #,'13685204','8841599005','13685002' # St Marks Orchard Lodge and Heating 2
