...
interpolator = RealTimeKwTarget.interpolator(school, school.aggregated_electricity_meters, Date.today)

puts RealTimeKwTarget.target_kw(interpolator, Time.now)
