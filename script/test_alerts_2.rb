...
script = {
  ...
  alerts:                   {
    alerts:    [ AlertHotWaterEfficiency ], # [ AlertOutOfHoursGasUsage ], # nil, 
    control:  {
                # print_alert_banner: true,
                # alerts_history: true,
                print_school_name_banner: true,
                # raw_variables_for_saving
                outputs:           %i[front_end_template_data front_end_template_tables front_end_template_table_data], # front_end_template_variables front_end_template_data raw_variables_for_saving],
                save_and_compare:  {
                                      summary:      true,
